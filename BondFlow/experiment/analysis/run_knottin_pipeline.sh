...
INPUT_DIR="/home/fit/lulei/WORK/xjt/Protein_design/BondFlow/BondFlow/experiment/cyclize/MC4R/condition_MC4R"  # Directory with PDB files
OUTPUT_DIR="${PROJECT_ROOT}/BondFlow/experiment/cyclize/MC4R/MDM2_knottin_evals2"   # Output directory for results
