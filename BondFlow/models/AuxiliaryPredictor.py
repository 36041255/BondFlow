...
from BondFlow.models.layers import AdaLayerNorm
...
class MaskedTokenNetwork(nn.Module):
    def __init__(self, n_feat):
        ...
        # self.adaLN_pair = AdaLayerNorm(20, d_time)
        self.proj1 = nn.Linear(n_feat, n_feat)
        self.proj2 = nn.Linear(n_feat, n_feat)
        self.proj3 = nn.Linear(n_feat, 21)        
    ...
    def forward(self, x):
        ...
        x = torch.relu(x)
        x = self.proj3(x)
        logits = x.permute(0,3,1,2).reshape(B, -1, N*L)
